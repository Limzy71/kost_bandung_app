    ...
    <div class="relative z-20 bg-white shadow-sm rounded-2xl md:rounded-full border border-gray-200 mb-16 p-2">
        <div class="flex flex-col md:flex-row items-center divide-y md:divide-y-0 md:divide-x divide-gray-100 w-full">
            ...
            <div class="w-full md:w-1/3 relative flex items-center px-4 py-2">
                <svg class="h-5 w-5 text-gray-400 flex-shrink-0" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <circle cx="9" cy="9" r="6"></circle>
                    <path d="M15 15l4 4"></path>
                </svg>
                <input wire:model.live.debounce.300ms="search" type="text" placeholder="Cari nama atau jalan..." class="w-full h-10 pl-3 pr-2 bg-transparent border-none focus:ring-0 text-gray-950 placeholder-gray-400 outline-none">
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
            ...
            <div class="group flex flex-col">
                ...
                <div class="aspect-[4/3] bg-gray-100 relative overflow-hidden rounded-2xl flex-shrink-0 cursor-pointer" onclick="window.location.href='{{ route('kost.show', $kost->slug) }}'">
                    ...
                    <div class="absolute top-4 left-4 flex flex-col gap-2 pointer-events-none">
                        @if($kost->boosted_at)
                            <span class="px-3 py-1 bg-gray-950 text-white rounded-full text-[10px] font-bold flex items-center gap-1.5 shadow-sm uppercase tracking-wider">
                ...
                <div class="mt-4 flex-1 flex flex-col justify-between">
                    <div>
                        <h2 class="text-lg font-bold text-gray-900 leading-tight group-hover:text-gray-600 transition-colors line-clamp-1">
                        ...
                        <div class="mt-3 flex flex-wrap items-center gap-2 relative z-10">
                            ...
                            <span class="rounded-full border border-gray-200 text-xs text-gray-700 px-3 py-1 font-semibold">
        ...
        @empty
            <div class="col-span-full py-20 flex flex-col items-center justify-center text-center">
                ...
                <p class="text-gray-500 mt-2 max-w-md font-light">Coba ubah filter atau kata kunci pencarian Anda untuk menemukan hunian yang sesuai.</p>
                <button wire:click="$set('search', ''); $set('gender', ''); $set('district', ''); $set('price_min', ''); $set('price_max', '');" class="mt-6 px-6 py-2.5 bg-gray-950 text-white font-medium rounded-full hover:bg-gray-800 transition-colors shadow-md relative z-10">Reset Filter</button>
            </div>
        @endforelse
    </div>
