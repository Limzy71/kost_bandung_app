        ...
        <form wire:submit="complete" class="space-y-6">
            ...
            <div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {{-- Pencari Kost --}}
                    <button type="button" wire:click="selectRole('user')"
                        class="p-5 text-left border-3 border-black rounded-xl transition-all cursor-pointer focus:outline-none focus:ring-0 dark:border-zinc-700 {{ $role === 'user'
                    ...
                    {{-- Pemilik Kost --}}
                    <button type="button" wire:click="selectRole('owner')"
                        class="p-5 text-left border-3 border-black rounded-xl transition-all cursor-pointer focus:outline-none focus:ring-0 dark:border-zinc-700 {{ $role === 'owner'
                            ? 'bg-[#FFE500] shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] -translate-x-0.5 -translate-y-0.5 dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.25)]'
                            : 'bg-white hover:bg-zinc-50 shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] hover:-translate-x-0.5 hover:-translate-y-0.5 active:translate-x-0.5 active:translate-y-0.5 active:shadow-none dark:bg-zinc-900 dark:hover:bg-zinc-800 dark:shadow-[3px_3px_0px_0px_rgba(255,255,255,0.25)]' }}">
                        <div class="flex items-center gap-3 mb-2">
                            <div class="w-9 h-9 bg-white border-2 border-black rounded-lg flex items-center justify-center text-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] shrink-0 dark:border-zinc-700">
            ...
            @if ($role === 'owner')
                <div class="space-y-5 p-5 bg-yellow-50 dark:bg-zinc-800/60 border-3 border-black dark:border-zinc-700 rounded-xl">
                    <div>
            ...
            <div class="pt-2">
                ...
                >
                    <span wire:loading.remove>Selesaikan & Lanjutkan</span>
                    ...
                    <x-icon wire:loading.remove name="lucide-arrow-right" class="w-4 h-4 stroke-[3]" />
                </button>
            </div>
