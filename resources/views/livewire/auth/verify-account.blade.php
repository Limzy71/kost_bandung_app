        ...
        <div class="space-y-4" wire:key="step-whatsapp-section">
            ...
            @else
                ...
                >
                    ...
                    @if ($isEditingPhone)
                        <div class="p-4 bg-yellow-100 dark:bg-zinc-900 border-2 border-black dark:border-zinc-700 rounded-xl space-y-3" wire:key="edit-phone-form">
                    ...
                    @else
                        ...
                        @if ($phoneSuccessMessage)
                            <div class="p-3 bg-lime-300 border-2 border-black rounded-lg text-xs font-black uppercase text-black flex items-center gap-2">
                        ...
                        <form wire:submit="verifyPhoneOtp" class="space-y-3 pt-1" wire:key="verify-otp-form">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-2.5">
                                <button type="submit" wire:loading.attr="disabled" wire:key="whatsapp-verify-submit-btn"
                                    class="sm:col-span-2 h-11 sm:h-12 bg-lime-400 hover:bg-lime-300 disabled:opacity-50 text-black border-2 border-black dark:border-zinc-700 font-black text-xs sm:text-sm uppercase shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] active:translate-x-0.5 active:translate-y-0.5 active:shadow-none transition-transform rounded-xl cursor-pointer inline-flex items-center justify-center gap-1.5">
                                ...
                                <button type="button"
                                    ...
                                    class="h-11 sm:h-12 px-3 bg-white hover:bg-zinc-100 text-black border-2 border-black dark:bg-zinc-800 dark:hover:bg-zinc-700 dark:text-white dark:border-zinc-700 font-black text-xs uppercase shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] active:translate-x-0.5 active:translate-y-0.5 active:shadow-none transition-transform rounded-xl cursor-pointer inline-flex items-center justify-center gap-1">
        ...
        <div class="space-y-4" wire:key="step-email-section">
            ...
            @else
                ...
                <div class="p-5 sm:p-7 bg-cyan-50 dark:bg-zinc-800/80 border-3 border-black dark:border-zinc-700 rounded-2xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] space-y-4">
                    ...
                    @if ($isEditingEmail)
                        <div class="p-4 bg-cyan-100 dark:bg-zinc-900 border-2 border-black dark:border-zinc-700 rounded-xl space-y-3" wire:key="edit-email-form">
                            <p class="text-xs font-black uppercase text-black dark:text-white flex items-center gap-1.5">
                    ...
                    @else
                        ...
                        <div class="pt-1">
                            <button type="button" wire:click="resendEmailVerification"
                                class="w-full h-11 sm:h-12 bg-cyan-300 hover:bg-cyan-400 active:translate-x-0.5 active:translate-y-0.5 active:shadow-none text-black border-2 border-black dark:border-zinc-700 font-black text-xs sm:text-sm uppercase tracking-wider rounded-xl shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-transform flex items-center justify-center gap-2 cursor-pointer">
