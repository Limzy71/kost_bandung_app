                ...
                <div class="space-y-3">
                    ...
                    @empty
                        <div class="bg-white dark:bg-zinc-900 border-4 border-black dark:border-zinc-700 rounded-2xl p-10 text-center shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] dark:shadow-[6px_6px_0px_0px_rgba(255,255,255,0.25)] space-y-3">
                            ...
                            <div>
                                <h3 class="text-lg font-black text-black dark:text-white uppercase">Belum Ada Obrolan</h3>
                            ...
                            <a href="{{ route('home') }}"
                                class="inline-flex items-center gap-2 bg-yellow-400 hover:bg-yellow-300 text-black border-3 border-black dark:border-zinc-700 font-black text-xs uppercase px-5 py-2.5 shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] dark:shadow-[3px_3px_0px_0px_rgba(255,255,255,0.25)] hover:-translate-x-0.5 hover:-translate-y-0.5 active:translate-x-0.5 active:translate-y-0.5 active:shadow-none transition-all rounded-lg">
            ...
            <div class="lg:col-span-3">
                    ...
                    <div class="bg-white dark:bg-zinc-900 border-4 border-black dark:border-zinc-700 rounded-2xl shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:shadow-[8px_8px_0px_0px_rgba(255,255,255,0.25)] overflow-hidden flex flex-col">
                        ...
                        <div class="p-5 border-b-4 border-black dark:border-zinc-700 bg-yellow-300 flex items-center justify-between gap-4">
                            <div class="min-w-0">
                                ...
                                <div class="flex flex-wrap items-center gap-2 mt-1">
                                    @if ($selected->kost)
                                        <span class="inline-flex items-center gap-1 px-2 py-0.5 bg-white dark:bg-zinc-900 border-2 border-black dark:border-zinc-700 text-[9px] font-black text-black dark:text-white uppercase rounded shadow-[1px_1px_0px_0px_rgba(0,0,0,1)] dark:shadow-[1px_1px_0px_0px_rgba(255,255,255,0.25)]">
                        ...
                        <div class="p-5 border-t-4 border-black dark:border-zinc-700 bg-white dark:bg-zinc-900">
                            <form wire:submit.prevent="sendMessage" class="space-y-3">
                                <label class="block text-[10px] font-black uppercase text-black dark:text-white mb-1">Kirim Pesan</label>
                ...
                @else
                    <div class="bg-white dark:bg-zinc-900 border-4 border-black dark:border-zinc-700 rounded-2xl p-12 text-center shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:shadow-[8px_8px_0px_0px_rgba(255,255,255,0.25)] space-y-4">
                        ...
                        <div>
                            <h3 class="text-xl font-black text-black dark:text-white uppercase">Pilih Obrolan</h3>
                            <p class="text-sm font-bold text-zinc-600 dark:text-zinc-400 mt-1">Klik salah satu obrolan di sebelah kiri untuk melihat pesan dan membalas pemilik kost.</p>
                        </div>
                    </div>
                @endif
            </div>
