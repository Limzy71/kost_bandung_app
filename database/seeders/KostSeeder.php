    ...
    public function run(): void
    {
        ...
        foreach ($dummyKosts as $index => $data) {
            $kost = Kost::create([
                ...
                'latitude' => config("bandung.districts.{$data['district']}.center.lat", -6.917464) + (rand(-50, 50) / 10000), 
                'longitude' => config("bandung.districts.{$data['district']}.center.lng", 107.619123) + (rand(-50, 50) / 10000),
                'is_available' => true,
                'status' => 'published',
                'total_rooms' => 10,
