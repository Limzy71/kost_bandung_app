<div class="min-h-screen bg-[#f8f9fa] bg-[linear-gradient(to_right,#e5e7eb_1px,transparent_1px),linear-gradient(to_bottom,#e5e7eb_1px,transparent_1px)]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 space-y-8">
        ...
        <div class="bg-white border-4 border-black p-6 sm:p-8 rounded-2xl shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-8 items-start">
            ...
            <div class="lg:col-span-2 space-y-4">
                <div class="flex flex-wrap items-center gap-2">
                    <button wire:click="setFilter('unanswered')" class="px-4 py-2 border-2 border-black font-black text-xs uppercase shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] active:translate-x-0.5 active:translate-y-0.5 active:shadow-none transition-all rounded-lg {{ $filter === 'unanswered' ? 'bg-amber-400 text-black' : 'bg-white text-black hover:bg-amber-100' }}">
                    ...
                    <button wire:click="setFilter('history')" class="px-4 py-2 border-2 border-black font-black text-xs uppercase shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] active:translate-x-0.5 active:translate-y-0.5 active:shadow-none transition-all rounded-lg {{ $filter === 'history' ? 'bg-zinc-400 text-black' : 'bg-white text-black hover:bg-zinc-100' }}">
                        ...
                        >
                            <div class="flex items-center justify-between gap-3">
                                <div class="flex items-center gap-2 min-w-0">
                                    ...
                                    <div class="min-w-0">
                                        <p class="text-sm font-black text-black truncate">{{ $conversation->user->name ?? 'Pengguna Terhapus' }}</p>
                            ...
                            <div class="flex flex-wrap items-center gap-2 mt-2">
                                <span class="px-2 py-0.5 bg-lime-300 border-2 border-black text-[9px] font-black uppercase rounded shadow-[1px_1px_0px_0px_rgba(0,0,0,1)]">
                                ...
                                <div class="flex flex-wrap items-center gap-2 mt-3">
                                    ...
                                    @if ($selected->isOpen())
                                        @if ($selected->awaiting_reply_at)
                                            <span class="px-2 py-0.5 bg-amber-400 border-2 border-black text-[9px] font-black uppercase rounded shadow-[1px_1px_0px_0px_rgba(0,0,0,1)] inline-flex items-center gap-1 animate-pulse">
                                ...
                                @if ($message->sender_type === 'admin')
                                    <div class="flex items-start justify-end gap-3">
                                        <div class="max-w-[80%] text-right">
                                            <div class="bg-lime-300 border-2 border-black p-3 rounded-xl shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]">
                        ...
                        <div class="p-5 border-t-4 border-black bg-white">
                            @if ($selected->isOpen())
                                <form wire:submit.prevent="replyConversation" class="space-y-3">
                                    <label class="block text-[10px] font-black uppercase text-black mb-1">Balasan Anda</label>
                                    ...
                                    <div class="flex flex-wrap items-center justify-between gap-3">
                                        <button
                                            ...
                                            class="inline-flex items-center gap-2 px-4 py-2.5 bg-rose-400 hover:bg-rose-300 text-black border-3 border-black font-black text-xs uppercase shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] active:translate-x-0.5 active:translate-y-0.5 active:shadow-none transition-all rounded-xl cursor-pointer">
                            ...
                            @else
                                <div class="flex flex-col sm:flex-row items-center justify-between gap-3">
                                    <div class="flex items-center gap-2 text-sm font-black text-black">
                                        <x-icon name="lucide-circle-slash" class="w-4 h-4 stroke-[2.5]" />
                                    ...
                                    <button
                                        ...
                                        class="inline-flex items-center gap-2 px-4 py-2.5 bg-zinc-800 hover:bg-black text-white border-3 border-black font-black text-xs uppercase shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] active:translate-x-0.5 active:translate-y-0.5 active:shadow-none transition-all rounded-xl cursor-pointer">
                ...
                @else
                    <div class="bg-white border-4 border-black rounded-2xl p-12 text-center shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] space-y-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-bold text-zinc-600 mt-1">Klik salah satu percakapan di sebelah kiri untuk membaca pesan dan membalasnya.</p>
                        </div>
                    </div>
                @endif
            </div>
