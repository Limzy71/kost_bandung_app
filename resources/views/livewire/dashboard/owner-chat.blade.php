                ...
                <div class="space-y-3">
                    @forelse ($conversations as $conversation)
                        ...
                        >
                            ...
                            <p class="text-[10px] font-black uppercase text-cyan-700 mt-1 truncate">
                    ...
                    @empty
                        <div class="bg-white border-4 border-black rounded-2xl p-10 text-center shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] space-y-3">
                            ...
                            <div>
                                <h3 class="text-lg font-black text-black uppercase">Belum Ada Percakapan</h3>
                    ...
                    <div class="bg-white border-4 border-black rounded-2xl shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] overflow-hidden flex flex-col">
                                ...
                                <div class="flex flex-wrap items-center gap-2 mt-1">
                                    @if ($selected->kost)
                                        <a href="{{ route('kost.show', $selected->kost->slug) }}" target="_blank"
                                            class="inline-flex items-center gap-1 px-2 py-0.5 bg-white border-2 border-black text-[9px] font-black uppercase rounded shadow-[1px_1px_0px_0px_rgba(0,0,0,1)] hover:bg-cyan-200 transition-all">
                        ...
                        <div class="p-5 border-t-4 border-black bg-white">
                            <form wire:submit.prevent="sendMessage" class="space-y-3">
                                <label class="block text-[10px] font-black uppercase text-black mb-1">Balas Pesan</label>
                ...
                @else
                    <div class="bg-white border-4 border-black rounded-2xl p-12 text-center shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] space-y-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-bold text-zinc-600 mt-1">Klik salah satu percakapan di sebelah kiri untuk membalas pesan pencari kost.</p>
                        </div>
                    </div>
                @endif
            </div>
